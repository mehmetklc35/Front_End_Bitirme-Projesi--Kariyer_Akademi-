...
const addHTML = (todo) => {
   ...
   editBtn.innerHTML = '<i style="pointer-events:none" class="fa-solid fa-pen-to-square"></i>';
   editBtn.addEventListener("click", editTodo); 
   const deleteBtn = document.createElement("button");
   deleteBtn.classList.add("todo_delete");
   // deleteBtn.textContent = "Delete";
   deleteBtn.innerHTML = '<i style="pointer-events:none" class="fa-solid fa-trash">';
   deleteBtn.addEventListener("click", deleteTodo); 
   const saveBtn = document.createElement("button");
   saveBtn.classList.add("todo_save");
   // saveBtn.textContent = "Save";
   saveBtn.innerHTML = '<i style="pointer-events:none" class="fa-solid fa-check"></i>';
